...
rcon = backend.games.counter.SourceLib.SourceRcon.SourceRcon('1.2.3.4', 27015, 'rconpw')
query = backend.games.counter.SourceLib.SourceQuery.SourceQuery('1.2.3.4', 27015)
...
class MyLogParser(backend.games.counter.SourceLib.SourceLog.SourceLogParser):
...
server = backend.games.counter.SourceLib.SourceLog.SourceLogListener(('1.2.3.4', 17015), ('1.2.3.4', 27015), MyLogParser())
